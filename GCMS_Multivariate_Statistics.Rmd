...
merged <- merge_notame_sets(corrected_r, corrected_b, corrected_l, merge = 'samples')
...
# Merge
result <- merge_notame_sets(corrected_r, corrected_l, corrected_b, merge = 'samples')
# Manually
# Combine assays
...
# Boxplot
combined_se_bp <- plot_sample_boxplots(combined_se,
                                  order_by = "Group",
                                  fill_by = "Group")
# PCA
