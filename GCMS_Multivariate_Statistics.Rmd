...
# Improve the low detection rate in the QC samples
fData(low_dr) <- fData(low_dr) %>%
...
# Show the percentage of flagged features as "Low_qc_detection"
percentage <- scales::percent(sum(flag(low_dr) == "Low_qc_detection",
                                  na.rm = TRUE)/nrow(fData(low_dr)))
